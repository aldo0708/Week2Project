public class BudgetCalculator {
    public static void main(String [] args){
        ...
        System.out.println((SALARY*RENT_PERCENT)+(SALARY*GROCERIES_PERCENT)+(SALARY*ENTERTAINMENT_PERCENT));
        System.out.println((SALARY)-((SALARY*RENT_PERCENT)+(SALARY*GROCERIES_PERCENT)+(SALARY*ENTERTAINMENT_PERCENT)));
    }
}